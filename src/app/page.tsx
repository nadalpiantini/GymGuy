...
export default function HomePage() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-primary/5 via-secondary/5 to-accent/5 py-24 lg:py-32">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center animate-in">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-8 animate-in-delay-2">
              Build Your Perfect{' '}
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center animate-in-delay-3">
              <Link href="/workouts">
                <Button size="touch-lg" variant="gradient" className="group animate-motivate-pulse hover:animate-energy-boost">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              ...
              <span className="bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent">Fitness Success</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 stagger-animation">
            <div className="bg-card border border-border rounded-xl shadow-soft p-8 group transition-all duration-300 hover:shadow-primary-glow hover:animate-card-lift">
              ...
              <h3 className="text-2xl font-bold mb-4">Workout Generator</h3>
            ...
            <div className="bg-card border border-border rounded-xl shadow-soft p-8 group transition-all duration-300 hover:shadow-secondary-glow hover:animate-card-lift">
              ...
              <h3 className="text-2xl font-bold mb-4">Structured Programs</h3>
              <p className="text-muted-foreground mb-6 leading-relaxed">
            ...
            <div className="bg-card border border-border rounded-xl shadow-soft p-8 group transition-all duration-300 hover:shadow-accent-glow hover:animate-card-lift">
            ...
            <div className="bg-card border border-border rounded-xl shadow-soft p-8 group transition-all duration-300 hover:shadow-energy-glow hover:animate-card-lift">
              ...
              <h3 className="text-2xl font-bold mb-4">Fitness Tools</h3>
              <p className="text-muted-foreground mb-6 leading-relaxed">
            ...
            <div className="bg-card border border-border rounded-xl shadow-soft p-8 group transition-all duration-300 hover:shadow-cardio-glow hover:animate-card-lift">
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Why Choose{' '}
              <span className="bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent animate-glow">GymGuy</span>?
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <h3 className="text-3xl md:text-4xl font-bold">Open Source & Self-Hostable</h3>
              <div className="space-y-6">
                <div className="flex items-start space-x-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">The core platform will always remain free and open source.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4 group">
                  <div className="w-8 h-8 bg-success/10 rounded-full flex items-center justify-center flex-shrink-0 group-hover:scale-110 group-hover:animate-set-complete transition-transform">
                  ...
                  <div>
                    <h4 className="text-xl font-semibold mb-2">Self-Hostable</h4>
                    <p className="text-muted-foreground">Run your own instance with full control over your data.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4 group">
                  <div className="w-8 h-8 bg-success/10 rounded-full flex items-center justify-center flex-shrink-0 group-hover:scale-110 group-hover:animate-set-complete transition-transform">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Built by the community, for the community. Contribute and shape the future.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4 group">
                  <div className="w-8 h-8 bg-success/10 rounded-full flex items-center justify-center flex-shrink-0 group-hover:scale-110 group-hover:animate-set-complete transition-transform">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Your data, your rules. Export everything and move to your own server anytime.</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="glass border border-white/20 rounded-xl shadow-soft p-8 lg:p-12 hover:shadow-glow transition-all duration-300">
              <h4 className="text-2xl font-bold mb-6 text-gradient">Modern Alternative</h4>
      ...
      {/* CTA Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-primary via-primary/90 to-secondary py-24 lg:py-32 animate-glow">
        <div className="absolute inset-0 bg-gradient-to-r from-primary/20 via-transparent to-secondary/20 animate-float"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-8">
            Ready to Transform Your{' '}
            <span className="bg-gradient-to-r from-white via-energy-200 to-white bg-clip-text text-transparent animate-glow">
              Fitness Journey
            </span>?
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link href="/workouts">
              <Button size="touch-lg" variant="secondary" className="group bg-white text-primary hover:bg-white/90 shadow-large hover:shadow-primary-glow animate-motivate-pulse">
                <span>Create Your First Workout</span>
                <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
              </Button>
            </Link>
            <Link href="/about">
              <Button size="touch-lg" variant="glass" className="group border-white/20 text-white hover:bg-white/10 hover:animate-energy-boost">
