          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <label htmlFor="profile-units" className="block text-sm font-medium text-gray-700 mb-2">
                    Units
                  </label>
                  <select
                    id="profile-units"
                ...
                <div>
                  <label htmlFor="profile-timezone" className="block text-sm font-medium text-gray-700 mb-2">
                    Timezone
                  </label>
                  <select
                    id="profile-timezone"
